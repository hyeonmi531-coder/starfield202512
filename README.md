...
- **Best Campaign (Section 4)**:
  - 반응형 중단점(`breakpoints`) 설정:
    - PC (1200px+): 3개 노출
    - 태블릿 (801px+): 2개 노출
    - 모바일 (800px-): 1.3개 노출 (옆 슬라이드가 살짝 보이는 구조)
...
본 프로젝트는 별도의 빌드 과정 없이 실행 가능합니다.

1. 프로젝트 폴더를 다운로드합니다.
2. `index.html` 파일을 웹 브라우저(Chrome, Edge 등)로 실행합니다.
   - _VS Code 사용 시 'Live Server' 확장을 통해 실행하면 더욱 원활하게 확인할 수 있습니다._

---

_이 프로젝트는 학습 목적으로 제작되었으며, 사용된 이미지와 로고의 저작권은 원저작권자에게 있습니다._
